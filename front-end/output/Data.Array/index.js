...
var unzip = $foreign["uncons'"](function (_329) {
    return new Data_Tuple.Tuple([  ], [  ]);
})(function (_330) {
    return function (ts) {
        var _463 = unzip(ts);
        return new Data_Tuple.Tuple($colon(_330.value0)(_463.value0), $colon(_330.value1)(_463.value1));
    };
});
...
var tail = $foreign["uncons'"](Prelude["const"](Data_Maybe.Nothing.value))(function (_327) {
    return function (xs) {
...
var span = function (p) {
    var go = function (__copy_acc) {
        return function (__copy_xs) {
            ...
            tco: while (true) {
                var _469 = uncons(xs);
                if (_469 instanceof Data_Maybe.Just && p(_469.value0.head)) {
                    var __tco_acc = $colon(_469.value0.head)(acc);
                    acc = __tco_acc;
                    xs = _469.value0.tail;
                    continue tco;
                };
...
var sortBy = function (comp) {
    return function (xs) {
        var comp$prime = function (x) {
            return function (y) {
                var _473 = comp(x)(y);
                if (_473 instanceof Prelude.GT) {
                    return 1;
                };
                if (_473 instanceof Prelude.EQ) {
                    return 0;
                };
                if (_473 instanceof Prelude.LT) {
                    return Prelude.negate(Prelude.ringInt)(1);
                };
                throw new Error("Failed pattern match at /home/travis/build/lewurm/geocaching-history/front-end/bower_components/purescript-arrays/src/Data/Array.purs line 390, column 3 - line 395, column 1: " + [ _473.constructor.name ]);
            };
        };
...
var replicateM = function (__dict_Monad_2) {
    return function (n) {
        return function (m) {
            ...
            throw new Error("Failed pattern match at /home/travis/build/lewurm/geocaching-history/front-end/bower_components/purescript-arrays/src/Data/Array.purs line 117, column 1 - line 118, column 1: " + [ n.constructor.name, m.constructor.name ]);
        };
    };
};
...
var nubBy = function (eq) {
    return function (xs) {
        ...
        if (_476 instanceof Data_Maybe.Just) {
            return $colon(_476.value0.head)(nubBy(eq)($foreign.filter(function (y) {
                return Prelude.not(Prelude.booleanAlgebraBoolean)(eq(_476.value0.head)(y));
            })(_476.value0.tail)));
        };
...
var some = function (__dict_Alternative_4) {
    return function (__dict_Lazy_5) {
        return function (v) {
            return Prelude["<*>"]((__dict_Alternative_4["__superclass_Prelude.Applicative_0"]())["__superclass_Prelude.Apply_0"]())(Prelude["<$>"](((__dict_Alternative_4["__superclass_Control.Plus.Plus_1"]())["__superclass_Control.Alt.Alt_0"]())["__superclass_Prelude.Functor_0"]())($colon)(v))(Control_Lazy.defer(__dict_Lazy_5)(function (_325) {
...
var init = function (xs) {
    ...
    throw new Error("Failed pattern match at /home/travis/build/lewurm/geocaching-history/front-end/bower_components/purescript-arrays/src/Data/Array.purs line 207, column 1 - line 208, column 1: " + [ xs.constructor.name ]);
};
        ...
        return function (__copy_xs) {
            ...
            tco: while (true) {
                ...
                if (_481 instanceof Data_Maybe.Just) {
                    var sp = span(op(_481.value0.head))(_481.value0.tail);
                    var __tco_acc = $colon($colon(_481.value0.head)(sp.init))(acc);
                    acc = __tco_acc;
                    xs = sp.rest;
                    continue tco;
                };
                ...
                throw new Error("Failed pattern match at /home/travis/build/lewurm/geocaching-history/front-end/bower_components/purescript-arrays/src/Data/Array.purs line 457, column 1 - line 458, column 1: " + [ _481.constructor.name ]);
            };
        };
    };
    return go([  ]);
...
var foldM = function (__dict_Monad_10) {
    return function (f) {
        return function (a) {
            return $foreign["uncons'"](function (_331) {
...
var filterM = function (__dict_Monad_13) {
    return function (p) {
        return $foreign["uncons'"](function (_328) {
...
var deleteBy = function (eq) {
    return function (x) {
        return function (_332) {
            ...
            return Data_Maybe.maybe(_332)(function (i) {
                return Data_Maybe_Unsafe.fromJust(deleteAt(i)(_332));
            })(findIndex(eq(x))(_332));
        };
    };
};
...
var alterAt = function (i) {
    return function (f) {
        return function (xs) {
            var go = function (x) {
                var _493 = f(x);
                if (_493 instanceof Data_Maybe.Nothing) {
                    return deleteAt(i)(xs);
                };
                if (_493 instanceof Data_Maybe.Just) {
                    return updateAt(i)(_493.value0)(xs);
                };
                throw new Error("Failed pattern match at /home/travis/build/lewurm/geocaching-history/front-end/bower_components/purescript-arrays/src/Data/Array.purs line 330, column 3 - line 339, column 1: " + [ _493.constructor.name ]);
            };
            return Data_Maybe.maybe(Data_Maybe.Nothing.value)(go)($bang$bang(xs)(i));
        };
    };
