...
var guard = function (__dict_MonadPlus_0) {
    return function (_162) {
        ...
        throw new Error("Failed pattern match at /home/travis/build/lewurm/geocaching-history/front-end/bower_components/purescript-control/src/Control/MonadPlus.purs line 35, column 1 - line 36, column 1: " + [ _162.constructor.name ]);
    };
};
module.exports = {
    MonadPlus: MonadPlus, 
