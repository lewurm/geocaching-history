module Data.Foreign.Class (IsForeign, readProp, readWith, readJSON, read) where
import Prelude ()
import Data.Foreign ()
...
foreign import instance charIsForeign :: Data.Foreign.Class.IsForeign Prim.Char
...
foreign import instance intIsForeign :: Data.Foreign.Class.IsForeign Prim.Int
foreign import instance arrayIsForeign :: (Data.Foreign.Class.IsForeign a) => Data.Foreign.Class.IsForeign (Prim.Array a)
